...
plot(hpc_new$d,hpc_new$Voltage,type="l",ylab="Voltage",xlab="datetime")
...
plot(hpc_new$d,hpc_new$Global_reactive_power,type="l",ylab="Global_reactive_power",xlab="datetime")